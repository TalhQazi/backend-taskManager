...
const SystemSettingsSchema = new mongoose.Schema(
  {
    ...
    templates: {
      ...
      taskAssignment: {
        enabled: { type: Boolean, default: true },
        subject: { type: String, default: "Task Assigned: {taskTitle}" },
        body: { type: String, default: "Hello {name},\n\nYou have been assigned a new task.\n\nTask: {taskTitle}\nProject: {projectName}\nPriority: {priority}\nDue Date: {dueDate}\n\nDescription: {description}\n\nPlease login to view details." },
      },
      fileAttachment: {
        enabled: { type: Boolean, default: true },
        subject: { type: String, default: "New File: {fileName} attached to {taskTitle}" },
        body: { type: String, default: "Hello {name},\n\nA new file '{fileName}' has been attached to the task '{taskTitle}'.\n\nPlease login to view it." },
      },
      commentAdded: {
        enabled: { type: Boolean, default: true },
        subject: { type: String, default: "New Comment on {taskTitle}" },
        body: { type: String, default: "Hello {name},\n\nA new comment was added to the task '{taskTitle}' by {authorName}.\n\nComment: {commentText}\n\nPlease login to view it." },
      },
      replyAdded: {
        enabled: { type: Boolean, default: true },
        subject: { type: String, default: "Reply on {taskTitle}" },
        body: { type: String, default: "Hello {name},\n\n{authorName} replied to your comment on task '{taskTitle}'.\n\nReply: {replyText}\n\nPlease login to view it." },
      },
      projectAssignment: {
        enabled: { type: Boolean, default: true },
        subject: { type: String, default: "Project Assigned: {projectName}" },
